...
/*!40000 DROP DATABASE IF EXISTS `blis_revamp`*/;

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `blis_revamp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
DROP TABLE IF EXISTS `blis_cloud_connections`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `blis_cloud_connections` (
...
--
-- Dumping data for table `blis_cloud_connections`
--

LOCK TABLES `blis_cloud_connections` WRITE;
/*!40000 ALTER TABLE `blis_cloud_connections` DISABLE KEYS */;
/*!40000 ALTER TABLE `blis_cloud_connections` ENABLE KEYS */;
UNLOCK TABLES;
...
(1,'00000000000000_add_blis_migrations.sql','2026-03-04 06:41:20'),
(2,'20250225803000_addsatellitelabusertype.sql','2026-03-04 06:41:20'),
(3,'20250310000000_addsatellitelabidtouser.sql','2026-03-04 06:41:20'),
(4,'20250406000000_addsatellitelabnametouser.sql','2026-03-04 06:41:20'),
(5,'00000000000001_add_new_revamp_tables_blis_3.9.sql','2026-03-04 06:42:36'),
(6,'20240925014433_createbliscloudconnectiontable.sql','2026-03-04 06:42:36'),
(7,'20241020032547_addbliscloudconnectionkeytolabconfig.sql','2026-03-04 06:42:36'),
(8,'20241027192939_addbliscloudpubkeyidtolabconfig.sql','2026-03-04 06:42:36'),
(9,'20241104000000_addlabnameandiptoconnections.sql','2026-03-04 06:42:36'),
(10,'20241124201109_updatecloudurlwidth.sql','2026-03-04 06:42:36'),
(11,'20250916133257_add_enc_option_to_labconfig.sql','2026-03-04 06:42:36');
...
INSERT INTO `encryption_setting` VALUES
(0);
...
INSERT INTO `equip_config` VALUES
(1,1,'PORT','5150'),
(1,2,'MODE','client'),
...
INSERT INTO `ii_quickcodes` VALUES
(1,'TCP/IP','PORT'),
(2,'TCP/IP','MODE'),
...
INSERT INTO `interfaced_equipment` VALUES
...
CREATE TABLE `lab_config` (
  ...
  `backup_encryption_enabled` tinyint(1) NOT NULL DEFAULT 0,
  `backup_encryption_key_id` int(11) unsigned DEFAULT NULL,
...
INSERT INTO `lab_config` VALUES
(12,'FONDATION SOCIALE SUISSE, HD PETTE','MAROUA',504,'blis_12',1,1,0,1,4,1,2,1,1,2,1,2,0,'d-m-Y',3,1,'Cameroon',0,NULL,NULL,NULL,0,NULL),
(127,'Testlab1','GT',53,'blis_127',1,0,0,1,2,1,2,1,1,0,0,2,0,'d-m-Y',1,1,'USA',0,NULL,NULL,NULL,0,NULL);
...
INSERT INTO `lab_config_access` VALUES
(123,12);
...
(26,'monu','18865bfdeed2fd380316ecde609d94d7285af83f','Ruban','rubanm@gatech.edu',0,'2010-04-30 03:22:39',0,3,'','en','2,3,4,6,7',NULL,NULL),
(27,'vempala','18865bfdeed2fd380316ecde609d94d7285af83f','Santosh Vempala','vempala@cc.gatech.edu',0,'2010-01-10 10:00:55',0,3,'','default','2,3,4,6,7',NULL,NULL),
(53,'testlab1_admin','18865bfdeed2fd380316ecde609d94d7285af83f','Testlab1 admin','',26,'2010-01-14 12:05:44',0,2,'','default','2,3,4,6,7',NULL,NULL),
(56,'testlab1_tech1','56cbdfb7197c476fdd872cf2872f38131d24c8be','Testlab1 Tech1','',26,'2010-04-29 23:53:06',127,0,'','en','2,3,4,6,7',NULL,NULL),
(57,'testlab1_tech2','56cbdfb7197c476fdd872cf2872f38131d24c8be','Testlab1 Tech2','',26,'2010-01-14 12:10:48',127,1,'','default','2,3,4,6,7',NULL,NULL),
(123,'cameroon_dir','dc2d9a08e3985a34838f43659ad7fdc614ee1297','Cameroon Country Dir.','',0,'2010-01-18 10:15:39',0,4,'677073324','fr','2,3,4,6,7',NULL,NULL),
(125,'ghana_dir','dc2d9a08e3985a34838f43659ad7fdc614ee1297','Ghana Country Dir.','',0,'2010-01-18 10:16:30',0,4,'','default','2,3,4,6,7',NULL,NULL),
(501,'tanzania_dir','dc2d9a08e3985a34838f43659ad7fdc614ee1297','Tanzania Country Dir.','',0,'2010-01-18 10:15:39',0,4,'','default','2,3,4,6,7',NULL,NULL),
(502,'drc_dir','dc2d9a08e3985a34838f43659ad7fdc614ee1297','DRC Country Dir.','',0,'2010-01-18 10:15:39',0,4,'','default','2,3,4,6,7',NULL,NULL),
(503,'uganda_dir','dc2d9a08e3985a34838f43659ad7fdc614ee1297','Uganda Country Dir.','',0,'2010-01-18 10:15:39',0,4,'','default','2,3,4,6,7',NULL,NULL),
(504,'pette_admin1','18865bfdeed2fd380316ecde609d94d7285af83f','Dr. Talaka','',123,'2021-08-08 19:00:00',12,2,'','fr','2,3,4,6,7',NULL,NULL),
(505,'sidney','c4acdecee31ca56ce9a5cae96e01d23fb83a0724','Sidney Akuro Atah','',123,'0000-00-00 00:00:00',12,0,'','default','2,3,4,6,7',NULL,NULL);
...
(20,'SATELLITE_LAB',1,'Princesca','2026-03-04 06:41:20');
...
INSERT INTO `user_type_config` VALUES
(1,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(2,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(3,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(4,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(5,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(6,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(7,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(8,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(9,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(10,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(11,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(12,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(13,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(14,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(15,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(16,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28'),
(17,'rwoptions','2,3,4,6,7','Aishwarya','0000-00-00','Aishwarya','2015-08-26 15:29:28');
...
CREATE TABLE `version_data` (
  ...
  `u_ts` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`id`)
