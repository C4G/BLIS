...
<table class='hor-minimalist-a'>
    ...
    <td><input type="text" id="commonTestName" class="variableData" size="50" style ="display: none;" value="<?php echo $testTypeMapping->name;  ?>"></input>
        <div id="commonTestNameFixed" class="fixedData"> <?php echo $testTypeMapping->name; ?></div><div id='commonTestNameError' style='display:none'>
    ...
    <td><input type="button" id="submit" type="submit" onclick="submitTestNames();" value="<?php echo LangUtil::$generalTerms['CMD_UPDATE']; ?>" size="20" /> <div id="success_message"><b><font color="green"> Update Successful </font></b></div></td>
    <?php }
    else
    { ?>
        <td><input type="button" id="submit" type="submit" onclick="submitTestNames();" value="<?php echo LangUtil::$generalTerms['CMD_UPDATE']; ?>" size="20" /></td>
    <?php } ?>
</table>
