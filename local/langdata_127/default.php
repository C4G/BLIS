...
$LANG_ARRAY = array (
	"general" => array (
		"ONE_TEST_PER_PAGE" => "1 Test Per Page",
		"TIPS" => "Tips",
		"USERNAME" => "Username",
		"PWD" => "Password",
		...
		"CMD_EXPORTEXCEL" => "Export to Excel",
		"CMD_EXPORT" => "Export",
		"CMD_SELECT" => "Select",
		"CMD_DELETE" => "Delete",
		"CMD_ENTER" => "Enter",
	...
	"lab_config_home" => array (
		...
		"MENU_TAT" => "Target TAT",
		"MENU_BATCHRESULTSFIELDS" => "Batch Results Fields",
		...
		"TIPS_BATCHRESULTSCONFIGSETTINGS" => "This is an editable page for setting various parameters that should be shown in the batch results page",
	...
	"reports" => array (
		...
		"OUT_OF_RANGE" => "Out of Range",
		"INTERPRETATION" => "Interpretation",
		"TIPS_HOLD_CTRL" => "Press and hold the \"Ctrl\" key to select multiple tests.",
		"INCLUDE_PATIENT_NAME" => "Include patient name",
		"INCLUDE_PATIENT_BIRTHDATE" => "Include patient birth date",
		"INCLUDE_PATIENT_SEX" => "Include patient sex",
        "INCLUDE_PATIENT_ID" => "Include patient ID",
		"PATIENT_DAILY_LOG_SHEET_NAME" => "Daily Log - Patients",
		"SPECIMEN_DAILY_LOG_SHEET_NAME" => "Daily Log - Specimens"
	) ,
	"edit_profile" => array (
