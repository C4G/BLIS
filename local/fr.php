...
$LANG_ARRAY = array ( 
	...
	"new_patient" => array ( 
		...
		"MSG_PID_INVALID" => "Id du patint Invalide/existe déjà.", 
	...
	"lab_configs" => array ( 
		...
		"TIPS_MISSING_LOCATION" => "Erreurr: Facility Name missing", 
		"TIPS_MISSING_MGR" => "Erreur: Lab Manager not selected", 
		"TIPS_MISSING_STYPES" => "Erreur: Pas d\'échantillon sélectionné", 
		"TIPS_MISSING_TTYPES" => "Erreur: Pas d\'Examen selectionné"
	) , 
	...
	"reports" => array ( 
		...
		"MENU_COUNTS" => "Counts", 
		"MENU_TAT" => "Delais de rendu des resultats", 
		...
		"TIPS_SPECIMEN" => "Choisir l\\\'échantillon pour le bilan de tous les examens fait par le patient.", 
		...
		"TIPS_NODISCRETE" => "Erreur: Aucune valeur numérique pour l\\\'examen trovée.", 
		...
		"TIPS_TATEXCEED" => "Aucun echantillon n\\\'a exédé le delai de rendu des resultats.", 
		...
		"MSG_INCLUDEPENDING" => "Inclure le Examens manquants.", 
	...
	"edit_profile" => array ( 
		...
		"MSG_PWDMINLENGTH" => "Mot passe a au Min 3 Lettres/et ou chiffres.", 
		"MSG_PROFILEUPDATED" => "Profil mi à jour", 
	...
	"blis_help_page" => array ( 
		...
		"MENU_SEARCH" => "Search", 
		"TIPS_SEARCH_1" => "This page allows us to search for a particular patient. You can enter a partial name here and it generates a list of patients with matching names.", 
		"TIPS_SEARCH_2" => "You can view the profile of the particular patient you want, check the tests and the results of tests for the patient.", 
		"TIPS_SEARCH_3" => "-", 
