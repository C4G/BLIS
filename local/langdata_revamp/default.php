...
$LANG_ARRAY = array ( 
		...
		"PASSWORDRESET_COMPLETE" => "Password Reset enabled. Visit login.php to reset the password",
		"NAME" => "Name", 
		"PHONE" => "Phone No.", 
		"EMAIL" => "Email", 
		"CMD_LOGIN" => "Login", 
	...
	"lab_config_home" => array ( 
		...
		"INSTRUMENTATION_INSTALL_DRIVERS" => "Device Drivers",
		"INSTRUMENTATION_CONFIGURE_DEVICE" => "Devices"
	) , 
	"lab_admins" => array ( 
		"TITLE" => "Lab Managers", 
