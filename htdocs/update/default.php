...
$LANG_ARRAY = array ( 
	...
	"login" => array ( 
		...
		"TIPS_NEWPWD" => "If you forgot yd, click on the Request a New Password link and a new, temporary password will be sent to your email address."
	) , 
	"home" => array ( 
		"TITLE" => "Home", 
		"WELCOME" => "Welcome", 
	...
	"edit_profile" => array ( 
		...
		"MSG_PWDMINLENGTH" => "Min password length is 8", 
