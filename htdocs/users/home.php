        ...
        <div class="card">
            <div class="card-body">
                <div class="text-wrap p-lg-6">
                    <h3 class="mt-0 mb-4"><?php echo LangUtil::getPageTerm("WELCOME")."!"; ?></h3>
                    <h4 class="mt-0 mb-4"><?php echo $_SESSION['username']?></h4>
                    <p><?php echo LangUtil::getPageTerm("TIPS_BLISINTRO"); ?></p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="text-wrap p-lg-6">
                    ...
                    <p><small><?php echo LangUtil::getPageTerm("TIPS_PWD"); ?></small></p>
                </div>
            </div>
        </div>
    </div>
...
<div id="update_div2" style="display:none;" class="warning">
    <a rel='facebox' id='update_link' href='../update/blis_update.php'>Click here to complete update to version
        <?php echo $VERSION ?></a>
</div>

<div id="update_div" style="display:none;" class="warning">
    <a id='update_link' href='javascript:blis_update_t();'>Click here to complete update to version
        <?php echo $VERSION ?></a>
</div>
...
<div id="update_success" style="display:none;" class="update_success">
    Update Successful! Welcome to C4G BLIS
    <?php echo $VERSION; ?>
</div>
