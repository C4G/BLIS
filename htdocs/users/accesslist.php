...
'lab_user_new.php', 'lab_user_type_new.php', 'reports_userlog.php', 'lab_user_edit.php','lab_user_type_edit.php', 'ofield_update.php', 'doctor_ofield_update.php', 'search_config_update.php', 'cfield_new.php', 'cfield_edit.php','worksheet_custom_fetchsection.php','worksheet_config_summary.php','worksheet_config_fetch.php','weekly_prevalance.php','users_select.php','userlog_fetch.php','update_blis.php','update_barcode_settings.php','toggle_test_reports.php','tests_selectbycat.php','tests_select.php','test_report_config_summary.php','test_report_config_fetch.php','test_list_by_site.php','test_agg_report_config_update.php','tat_ttype_weekly.php','tat_ttype_monthly.php','tat_ttype_daily.php','tat_table.php','st_types_update.php','specimen_aggregate_reports_update.php');

$adminPageList = array();
array_push($adminPageList, 'lab_configs.php', 'catalog.php', 'reports.php', 'data_backup.php', 'update.php', 'st_types_update.php', 'remarks_edit.php', 'lab_config_tat_update.php',
'stock_management.php', 'stock_edit.php', 'lab_user_new.php', 'lab_user_type_new.php', 'reports_userlog.php', 'lab_user_edit.php', 'lab_user_type_edit.php', 'ofield_update.php', 'doctor_ofield_update.php','search_config_update.php', 'cfield_new.php', 'cfield_edit.php','worksheet_custom_fetchsection.php','worksheet_config_summary.php','worksheet_config_fetch.php','weekly_prevalance.php','users_select.php','userlog_fetch.php','update_blis.php','update_barcode_settings.php','toggle_test_reports.php','tests_selectbycat.php','tests_select.php','test_type_name_check.php','test_report_config_summary.php','test_report_config_fetch.php','test_list_by_site.php','test_agg_report_config_update.php','tat_ttype_weekly.php','tat_ttype_monthly.php','tat_ttype_daily.php','tat_table.php','st_types_update.php','specimen_name_check.php','specimen_aggregate_reports_update.php');
