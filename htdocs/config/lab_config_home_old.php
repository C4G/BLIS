				...
				<div class='right_pane' id='inventory_div' style='display:none;margin-left:10px;'>
                                ...
                                <div class='right_pane' id='billing_div' style='display:none;margin-left:10px;'>
									...
									<form id='billing_form' name='billing_form' action='ajax/billing_update.php' method='post'>
                                        ...
                                        <div id="exchange_rate" <?php if($defaultCurrency==""){?>style='display:none;'<?php }?>>
                                        <?php 
                                        ...
                                        <?php $row++; }?>
                                        <tr><td colspan="4">
                                        <br/><a href="javascript:addCurrencyRatio();"><?php echo LangUtil::$generalTerms['ADD_CURRENCY_RATE']; ?></a><br/></td></tr>
                                        </table>
                                        </div>
                                        ...
                                        <?php }  else {
											echo "All exiting currency conversions have been entered";
										}?>
                                        </div>
                                        <br/>                                       
                                        <div>
