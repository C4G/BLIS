...
<table name="page_panes" cellpadding="10px">
	...
	<div id='specimen_count_div' style='display:none;' class='reports_subdiv'>
		...
		<form name="user_stats_form_all" id="user_stats_form_all" action="reports_user_stats_all.php" method='post'>
                    <table cellpadding="4px">
			<?php
			$site_list = get_site_list($_SESSION['user_id']);
			if(count($site_list) == 1)
			...
			?>
                ...
                <form name="individual_user_stats_form" id="individual_user_stats_form" action="reports_user_stats_individual.php" method='post' target='_blank'>
                    <table cellpadding="4px">
			<?php
			$site_list = get_site_list($_SESSION['user_id']);
			if(count($site_list) == 1)
