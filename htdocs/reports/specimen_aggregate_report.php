...
<form name='word_format_form' id='word_format_form' action='export_word_aggregate.php' method='post' target='_blank'>
    ...
    <input type='hidden' name='report_type' value='specimen_aggregate_report' id='report_type' />
...
$configArray = getSpecimenCountGroupedConfigCountryDir($lab_id_revamp);
...
<table style='border-collapse: collapse;'>
    <thead>
        ...
        <?php
            ...
            $test_type_list = get_lab_config_specimen_types($location[0], false, 1);
                    ...
                    if($byAge == 1)
                    {
                        ...
                        foreach($age_slot_list as $age_slot)
                        {
                            ...
                            if($byGender == 1)
                            {
                                ...
                                {
                                    $gender = 'M';
                                    $count_male_t = get_specimen_count_grouped_country_dir($test_type_id, $date_from, $date_to, $gender, $age_from, $age_to, $age_unit);
                                    $gender = 'F';
                                ...
                                {
                                    $gender = 'M';
                                    $count_male_c = get_specimen_count_grouped_country_dir($test_type_id, $date_from, $date_to, $gender, $age_from, $age_to, $age_unit, 1);
                                    $gender = 'F';
