...
<div id='report_content'>
    ...
    <font size="4"><?php
        ...
        foreach($_REQUEST["sites"] as $value)
        {
            //echo "value: ". $value;
            $site_data =  explode("|",$value);
            $lab_id =  $site_data[1];
            $site_id = $site_data[0];
            $site_name = $site_data[2];

            #$site_info = get_site_info($value);
            ?>
            <br>
            ...
            <table>
                ...
                <hr>
                <tr>
                    <td><b><font size="4"><?php echo "SITE".LangUtil::$generalTerms['SITE']; ?></b></td>
                    <td><font size="4"><?php echo ":&nbsp;"?></td>
                    <td><font size="4"><?php echo $site_name?></td>
                </tr>
                </tbody>
            </table>
            <?php
            ...
            if($bySection == 0)
            {
                ...
                <table style='border-collapse: collapse;'>
                    ...
                    <?php
                    $test_type_list = get_lab_config_test_types($lab_id); // to get test type ids
//                    /print_r($test_type_list);
                    ...
                    */
                    $saved_db = DbUtil::switchToLabConfig($lab_id);
                        ...
                        if($byAge == 1)
                        {
                            ...
                            foreach($age_slot_list as $age_slot)
                            {
                                ...
                                if($byGender == 1)
                                {
                                    ...
                                    {
                                        $gender = 'M';
                                        $count_male_t =  get_sitewise_count_grouped_country_dir($test_type_id, $site_id, $date_from, $date_to, $gender, $age_from, $age_to, $age_unit);
                                        ...
                                        $gender = 'F';
                                        $count_female_t =  get_sitewise_count_grouped_country_dir($test_type_id, $site_id, $date_from, $date_to, $gender, $age_from, $age_to, $age_unit);
                                    ...
                                    {
                                        $gender = 'M';
                                        $count_male_c =  get_sitewise_count_grouped_country_dir($test_type_id, $site_id, $date_from, $date_to, $gender, $age_from, $age_to, $age_unit, 1);
                                        ...
                                        $gender = 'F';
                                        $count_female_c =  get_sitewise_count_grouped_country_dir($test_type_id, $site_id, $date_from, $date_to, $gender, $age_from, $age_to, $age_unit, 1);
            ...
            else
            {
                ...
                $sections = array();
                $sections = get_test_categories_data($lab_id);
                ...
                for($sc = 0; $sc < $sec_count; $sc++)
                {
                    ...
                    <table style='border-collapse: collapse;'>
                        ...
                        <tbody>
                        <?php
                        $test_type_list = get_test_ids_by_category($sec_code, $lab_id);
...

        {
            ...
            <div id="aggregateResults">
                <table>
                    ...
                    <hr>
                    <tr>
                        <td><b><font size="4"><?php echo LangUtil::$generalTerms['ALL_SITES']; ?></b></td>
                        <td><font size="4"><?php echo ":&nbsp;"?></td>
                    </tr>
                    </tbody>
                </table>
