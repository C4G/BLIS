...
# Generates a patient bill in a printable format
...
$bill_information = generate_bill_data_for_patient_and_date_range($patient_id, $date_from, $date_to);
var_dump($bill_information);
