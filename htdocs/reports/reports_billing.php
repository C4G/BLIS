...
$logo_storage_path = $STORAGE_DIR . "/logos/logo_billing_" . $lab_config_id . ".jpg";
if (file_exists($logo_storage_path)) {
	?>
	<img src='<?php echo "logo_serve.php?id=" . $lab_config_id . "&type=billing"; ?>' alt="Big Boat" height='140px'></src>
	<?php
}
?>
</div>
