...
<script type="text/javascript">
	$(document).ready(function(){
		//var nextLink = document.getElementById("next_link");
                //nextLink.setAttribute('href',"yourlink.htm");
	});
</script>
<div id="data_table">
<?php
...
<table class='hor-minimalist-c' id='patientListTable' name='patientListTable'>
    ...
    ?>
                <a onclick="javascript:get_next('<?php echo $next_link; ?>');">Next</a>
</div>
...
<div id="next_link" style="display: none;">
    ...
    ?>
    <a href="javascript:get_next_data(<?php echo $next_link; ?>)">Next >></a>
</div>
